...
public final class DreamColors {
    ...
    public static final int FLAME = Color.rgb(255, 164, 107);
    public static final int DROP = Color.rgb(102, 197, 235);
    public static final int STAR = Color.rgb(255, 207, 70);
    public static final int INK = Color.rgb(83, 58, 124);
    public static final int DEEP = Color.rgb(121, 88, 178);
    public static final int MUTED = Color.rgb(151, 123, 181);
    public static final int WARM_WHITE = Color.rgb(255, 251, 244);
    public static final int WHITE_SOFT = Color.argb(238, 255, 252, 247);
    public static final int GLASS = Color.argb(188, 255, 250, 250);
